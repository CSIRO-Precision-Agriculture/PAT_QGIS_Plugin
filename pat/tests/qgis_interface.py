...
.. note:: This source code was copied from the 'DataPlotly QGIS plugin' application
        (https://github.com/ghtmtt/DataPlotly/blob/master/DataPlotly/test/qgis_interface.py)
